...
to say KyrverthSmellDesc:
	if KyrverthStage is 0:
		...
		say "     The dragon has a [one of]thick[or]pungent[at random] musk that floods the room with a tang that invades your nostils and causes [if player is male]your [cock of player] cock to engorge[else]your [one of]cunt[or]vagina[or]nether regions[at random] to moisten[end if]";
...
to say KyrverthNormalChat: [Quest give and normal chat]
	if KyrverthQuestGiven is 0 and (KyrverthTimer - turns >= 6): [Quest give]
		if KyrverthStage is 0:
			...
			say "DEBUG: You shouldn't be able to see this";
		...
		if randomnumber >= 1 and randomnumber <= 5:
			...
			if ((cocks of player >= 1 and KyrverthMaleBoning is 0) or KyrverthStage is not 3):
				say "     'Someday I'll look for a mate, hopefully I will have a big enough hoard to draw them in by then...'";
				...
				say "     'How's about you and I have some fun?' Kyrverth's hand strays toward his vent and strokes it a few times, showing the tip of a massive cock. 'I've been wanting to make some eggs...'";
		else if randomnumber >= 36 and randomnumber <= 40:
