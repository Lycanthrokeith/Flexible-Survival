		...
		if fightoutcome >= 20 and fightoutcome <= 29:[lost]
			...
			if fightoutcome >= 20 and fightoutcome <= 29:[lost]
				...
				if fightoutcome >= 20 and fightoutcome <= 29:[lost]
					...
					say "     With a moan, the newly made centaur shakes his head, finally getting out of the daze a hit on the head gave him. Rubbing his head, he says 'Ouch, where am I? Those horse dudes pack quite a punch...' - then he looks down and sees his hoofed front legs - 'What the hell? My legs!' He hurriedly stands up from the ground, stumbling around on his four legs before he gets them under control. Noticing you standing nearby, he looks at you warily. 'Someone else who's gonna jump me? No wait - I think I remember you fought off those horse dudes - didn't you? So thanks, I guess. He trots towards you and gives you a hand, saying 'I'm Thomas.'";
					if graphics is true:
						project the figure of Thomas_soft_icon;
					WaitLineBreak;
					say "     The two of you talk for a while, with Thomas telling you he just wanted to get away from the city through the scarcely populated and less dangerous (or so he thought) plains. You in turn tell him what you know about the infection, how the changes work and so on. Having gotten to know you a little bit, Thomas then suddenly broaches a sensitive topic to you. 'You know, I feel pretty strange back there' - with a nod to his hindquarters - '...I mean, stranger than I think it should. Could you - maybe - check it out? Please.'";
					LineBreak;
					say "     Easily convinced to help out, you walk around Thomas's centaur body and - oh. Looks like in addition to the quite admirable horsecock and balls, Thomas has a mare's pussy. Looks a bit swollen and moist too - he might even be in heat.";
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				...
				if (nam is "Talk him into anal sex"):
					say "[ThomasTalk3]";
				else if (nam is "Come clean and tell him he's a herm"):
					say "[ThomasTalk4]";
				else if (nam is "Ask about his herd"):
					say "[ThomasTalk5]";
				else if (nam is "Offer your help for some revenge on his centaur rapists"):
					say "[ThomasTalk6]";
				else if (nam is "Give Thomas five soda cans"):
					say "[ThomasTalk7]";
				else if (nam is "Go meet the prairie dogs"):
					say "[ThomasTalk8]";
...
to say ThomasTalk3:
	...
	if dice + bonus >= 15:
		...
		LineBreak;
		say "     With crossed arms in front of his chest, Thomas listens to your arguments, then says 'Err... thanks, but no thanks. Not gonna happen.' He turns his upper body a bit and looks back over his equine back. 'That centaur fucker buggered me and look how I ended up. And it hurt like a bitch.'";
...
to say ThomasTalk5:
	...
	if libido of Thomas is 1 or libido of Thomas is 21:
		say "     Thomas looks out towards the other centaur standing further off. 'Sandy is still pretty frightened and shy. Those fuckers really got to her, making her believe she only had value as their sex-pet. Thanks for helping me get her out.'";
	else if libido of Thomas is 2 or libido of Thomas is 22:
	...
	else if libido of Thomas is 10:
		...
		say "     Thomas looks out towards the two centaurs standing further off. 'Sandy is still pretty frightened and shy. Those fuckers really got to her, making her believe she only had value as their sex-pet. At least Felix has been understanding about it and really helps out by calming her down and getting her to open up.'";
	else if libido of Thomas is 12:
		say "     Thomas looks out towards the three centaurs standing further off. 'Nice little herd, hm? Jill and Felix have become good friends, and with them to keep Sandy company, she's gotten a lot better.'";
...
to say ThomasTalk8:
	if graphics is true:
		project the figure of Thomas_face_icon;
	say "     After trekking quite a bit through the open plain, Thomas points at several large rubble mounds further ahead. A sign reading 'Glenwood Mining Company' still stands in front of them. You can see a pretty large pit nearby - looks like it's been dug recently, most likely before the fuel ran out on all the excavators standing around. A shallow ramp leads down into it and the walls inside are filled with tunnel openings. Walking down the ramp, Thomas rings a bell someone has set up there.";
	LineBreak;
	...
	if calcnumber is 1:[suck them]
		...
		LineBreak;
		say "     Quite a while later, with uncounted numbers of cumshots into your stomach (you suspect some of the guys came back for two servings) you're finally done. Thomas helps you back to your feet and the two of you watch the pretty jolly and grinning work group assemble and move out. The foreman nods to your centaur friend and says 'We'll have the job done right quick. You'll see.' before they leave.";
		infect "Prairie Dog";
		infect "Prairie Dog";
		infect "Prairie Dog";
	else if calcnumber is 2:[threaten]
	...
	if player consents:
		...
		if fightoutcome >= 20 and fightoutcome <= 29:[lost]
			...
			if fightoutcome >= 20 and fightoutcome <= 29:[lost]
				...
				say "     With another centaur beating a hasty retreat, a third one rushes at you.";
				challenge "Centaur Stallion";
				if fightoutcome >= 20 and fightoutcome <= 29:[lost]
					say "     [LoseToCentaurs2]";
				else if fightoutcome >= 30:[fled]
					...
					say "     The fight is going well, and you have a moment to look around - Thomas and Jill have taken down three of the other attackers and are engaged with a fourth - which only leaves an older bearded centaur for you. He shouts 'I'll show you to make off with my daughter! She's supposed to bring in good money!'";
					challenge "Centaur Stallion";
					if fightoutcome >= 20 and fightoutcome <= 29:[lost]
						say "     [LoseToCentaurs2]";
					else if fightoutcome >= 30:[fled]
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				...
				if (nam is "Have him blow your cock"):
					...
					say "[ThomasSex6]";
				else if (nam is "Finger Thomas ass"):
					say "[ThomasSex7]";
				else if (nam is "Take Thomas ass"):
					say "[ThomasSex8]";
...
to say ThomasSex5: [Thomas pussy fucked by player]
	...
	if cock length of player < 20:
		say "     Who could resist that? Quickly throwing off your clothes, you bring your rock hard [cock of player] cock to Thomas's wet, winking pussy and thrust deep into him in one go. His pussy is very large, taking everything you've got easily. Though clearly equipped for bigger cocks, Thomas does his best to grip you tight with his vaginal muscles and the two of you enjoy yourselves quite a bit. Fucking the black centaur herm with abandon, you soon feel a familiar tingle in your balls and plunge in deep one last time before you start cumming. Spurt after spurt of your fertile seed jet out of your hard shaft and vanish in the depths of his vagina.";
		WaitLineBreak;
		say "     Resting against his muscled hindquarters until you catch your breath, you then pull your cock out of its moist and warm cave. As your partner hasn't come yet, you bring your hand to his pussy and start to massage it. Slipping three, then four fingers, then your whole hand into the centaur's body, you stroke his inner passage, wet with your cum and his juices. Feeling around a bit, you find a spot that seems especially sensitive judging from the joyful shouts it draws from Thomas every time you glide over it. Concentrating on that, it doesn't take much longer until the centaur herm orgasms, femcum gushing out of his opening and dripping off your arm.";
	else:
		say "     Who could resist that? Quickly throwing off your clothes, you bring your rock hard [cock of player] cock to Thomas's wet, winking pussy and thrust deep into him in one go. His pussy is very large, but your shaft fills it out quite nicely, evoking a whole new level of moans from Thomas. Hitting all the sensitive spots deep inside him, the black centaur gasps, then shouts for you to fuck him harder. Eagerly complying, you fuck Thomas with abandon, thrusting in and out of his equine body.";
		WaitLineBreak;
...
to say ThomasSex6: [player's pussy fucked by Thomas]
	say "     You go and give Thomas a hungry kiss, your tongues exploring each other's mouths. Making out with him is great and you almost forget what you were planning to do, only reluctantly pulling back from the centaur herm's lips. Running your hands down over Thomas's muscled chest, then along his flank as you walk around his equine body. Then you kneel down and rub his balls, stroking his black horsecock as it emerges from its sheath. Groaning in anticipation as his cock hardens, Thomas says 'I can't wait to fuck you.' and steps a bit to the side so you're now fully under him.";
	LineBreak;
	...
	if (HP of Thomas > 0 and HP of Thomas < 100) and Dry Plains is known and humanity of player > 10: [player met him and is sane]
		...
		if HP of Thomas is 4 or HP of Thomas is 5:[player knocked him up]
			...
			if HP of Thomas is 1:[player didn't try to have mare sex with Thomas]
				say "     Calling a young colt out to meet you, Thomas introduces him to you as Kurt, his son with Felix. Being the result of you saving his father, the chipper little boy is very eager to have you tell him all about it, getting pretty big eyes as you recount the size of the beast chasing Felix and your role in getting the centaur away from it. Later, after he's gone off to amaze his friends with the story, Thomas and Felix invite you to their hut and you have a long talk about your time in the city and what happened since.";
				say "     As the evening progresses and racier topics come up, their arousal rises, and they soon are touching and kissing each other. Not being shy at all about such things, this quickly moves on to Felix mounting Thomas, the young stallion's long horsecock driving into your herm friend's pussy. It's quite a night to remember after that. Having had a ringside seat for the conception of their second child, you end up becoming the new colt's godparent and often come back to visit the centaurs.";
			else if HP of Thomas is 2 or HP of Thomas is 3:[player was interested in mare sex with Thomas, Felix not lost]
				say "     Calling a young colt out to meet you, Thomas introduces him to you as Kurt, his son with Felix. Being the result of you saving his father, the chipper little boy is very eager to have you tell him all about it, getting pretty big eyes as you recount the size of the beast chasing Felix and your role in getting the centaur away from it. Later, after he's gone off to amaze his friends with the story, Thomas and Felix invite you to their hut and you have a long talk about your time in the city and what happened since.";
				if player is male:[knocks Thomas up with one of two twins]
