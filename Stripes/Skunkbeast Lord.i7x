...
When Play begins:
	...
	now face change entry is "your head flows and shifts, reforming into that of a feral skunk"; [ Face TF text. Format as "Your face tingles as [face change entry]." ]
