...
Instead of resolving a Poor Kitty:
	if HP of rubber tigress is 0:
		...
		say "     [bold type] You consider your options, you wonder if you should try offering her another treat or just drive her off.[roman type][line break]";
		LineBreak;
...
to say artemissex4:	[M-oral 3]
	say "     Suddenly feeling quite turned on, you notice your kitty's sexy muzzle and decide to get a little relief[if HP of rubber tigress < 11]. With your poor kitty's lack of gender, she's more than eager to get some sexual fun now that she's got you to please[else]. Having you to thank for her new, gendered state, she's clearly eager for an opportunity to thank you... with mouth[end if]. She runs her tongue along your [cock size desc of player] [cock of player] cock. Her tongue has rough, rubbery texture that's very pleasing. Soon enough she has you very excited and leaking precum. She slurps over your balls before taking your shaft into her muzzle and suckling at it. You moan in pleasure, rub her ears and release your hot seed down her throat[if cock width of player > 40], rounding her empty belly with your seed[else if cock width of player > 20], filling her empty belly with your seed[end if]";
	if lastArtemisglomp >= 8 or HP of rubber tigress < 6:
		if cock width of player > 20:
			say ". After having been so well fed, she gives a sleepy yawn";
		else:
...
to say artemissex8:	[Engulf and masturbate]
	if location of player is State Fair and HP of rubber tigress > 7 and ( artemisstatefairrt is false or a random chance of 2 in 3 succeeds ):
		...
		if a random chance of 1 in 3 succeeds:
			...
			say "     Catching sight of the glancing looks the tigress is giving you and feeling that it might be fun to snuggle up extra-close to your kitty again, you drop your gear and leap atop her, running your [if bodyname of player is listed in infections of Felinelist]paws[else]hands[end if] across her body, pulling her close[if cocks of player > 1]. You grind your stiff cocks against her[else if cocks of player is 1]. You grind your stiff cock against her[else]. You rub your crotch against her, pressing your pussy against her[end if]. She squirms a little at first, but you soon feel her rubbery skin spreading over you. With your loins pressed right against her, she starts with them. Flowing latex spreads out from there over your hips and chest as you can feel the stuff [if player is male and cunts of player > 1]wrapping around your stiff manhood and sealing over your pussies before pushing further into you, coating and sealing your cunts in a protective layer of herself[else if player is male and cunts of player is 1]wrapping around your stiff manhood and sealing over your pussy before pushing further into you, coating and sealing your cunt in a protective layer of herself[else if cocks of player > 1]wrapping around your stiff cocks and coating them in a snug, squeezing layer of herself[else if cocks of player is 1]wrapping around your stiff cock and coating it in a snug, squeezing layer of herself[else if cunts of player > 1]encapsulating your juicy folds before pushing further into you, coating and sealing your cunts in a protective layer of herself[else if cunts of player is 1]encapsulating your juicy folds before pushing further into you, coating and sealing your cunt in a protective layer of herself[end if][if anallevel > 1]. You can't help but moan as a pushing sensation at your anus leads it to opening and allowing more of her to flow into you and coat your back passage as well in herself[end if]. It is all so very arousing to be giving so much of yourself to your loyal tigress pet.";
			...
			if a random chance of 1 in 1 succeeds:				[more variations to come]
				...
				if anallevel > 1 and ( player is puremale ) and ( a random chance of anallevel in 12 succeeds or ( player is mpreg_ok and a random chance of 1 in 12 succeeds ) or ( player is submissive and a random chance of 1 in 12 succeeds ) ) and guy is not banned:
					...
					if a random chance of 3 in 5 succeeds or ( player is submissive and a random chance of 1 in 5 succeeds ):		[M/M bottom]
						say "male [bodyselector] enticed by the currently male [']tiger['] and [']his['] sultry moves. It seems Artemis would prefer to go for some gay sex with your borrowed body this time to broaden her enjoyment. After [one of]some mutual stroking with his current partner[or]licking and sucking his cock to get him ready[or][if anallevel is 3]bending over and getting rimmed by his current partner[else]kissing and making out for a while[end if][as decreasingly likely outcomes], he ends up [one of]on all fours[or]bent over a bench[or]spread across the hood of a car[or]pinned against a wall[at random] with the [bodyselector] forcing his cock into her yielding asshole (and thereby into you).";
...
to say artemissex10:	[vagina]
	if player is male and a random chance of 2 in 3 succeeds:
		...
		if a random chance of 1 in 3 succeeds and thirst of rubber tigress is not 0:
			say "[if thirst of rubber tigress is 1]. You reach around for her stiff manhood, stroking that sextoy cock of hers while you screw her in the ass[else if thirst of rubber tigress is 2][one of]. You reach forward to her muzzle, scritching it until that sextoy cocktongue of hers emerges for you to stroke[or]. Leaning overtop of her, you turn her head towards yours, pulling her into a kiss that soon has her sextoy tongue buried in your mouth[at random][else if thirst of rubber tigress is 3][one of]. You run your hand from her ass along her tail, you reach her tail's tip and stroke it, coaxing the black-colored tip to draw back and reveal her tailcock for you to stroke[or]. Pulling her tail to your mouth, you lick and kiss at its tip, coaxing the ebon dildo hidden within to be reveals for you to suck on while fucking her[at random][end if]";
		say ".";
...
to say artemissex11:	[cock]
	if (player is female and a random chance of 2 in 3 succeeds) or (cunts of player is 0 and a random chance of anallevel in 5 succeeds):
...
to artemisnap:
	...
	if HP of rubber tigress >= 11:
		...
		if player is herm:		[herm]
			say "     But it's not like she does this for long, having something else she's wanted so much more to enjoy right between her legs. Returning to where you were resting, she takes a seat and reaches down, running her smooth paws over your genitals, hers now as well, mewling softly in pleasure at the sensation. Soon she's masturbating, stroking her cock[smn] and fingering her puss[yfn]. She plays with herself frantically and with little direction, simply overloading herself on the pleasures of having them. She goes at it for hours, filling your walking dream with the sensation cumming again and again as your juices soak her thighs and your seed is released all across your hijacked body. Eventually, she's finally sated for a time and you pass out fully into sleep.";
		else if player is male:				[male]
			say "     But it's not like she does this for long, having something else she's wanted so much more to enjoy right between her legs. Returning to where you were resting, she takes a seat and reaches down, running her smooth paws over your maleness, hers now as well, mewling softly in pleasure at the sensation. Soon she's masturbating, stroking her [cock size desc of player] cock[smn] and mrowling happily. She plays with herself frantically and with little direction, simply overloading herself on the pleasures of having a gender. She goes at it for hours, filling your walking dream with the sensation cumming again and again as your sticky seed is released all across your hijacked, rubber-coated body. Eventually, she's finally sated for a time and you pass out fully into sleep.";
		else if player is female:				[female]
			say "     But it's not like she does this for long, having something else she's wanted so much more to enjoy right between her legs. Returning to where you were resting, she takes a seat and reaches down, running her smooth paws over your genitals, hers now as well, mewling softly in pleasure at the sensation. Soon she's masturbating, fingering her [cunt size desc of player] puss[yfn] and mrowling happily. She plays with herself frantically and with little direction, simply overloading herself on the pleasures of having them. She goes at it for hours, filling your walking dream with the sensation cumming again and again as she uses your hijacked body to frig you both over and over, letting your juices soak her thighs. Eventually, she's finally sated for a time and you pass out fully into sleep.";
		else:								[neuter]
		...
		say "     Adding to this is the increasingly pleasurable sensation of her rubbery goo flowing [if player is herm]over and into you dual genitals[else if cocks of player > 1]over your cocks[else if cocks of player is 1]over your cock[else if cunts of player > 1]into your cunts[else if cunts of player is 1]into your cunt[else]into your back passage[end if]. The final moments with her covering your head and going down your throat is still somewhat disconcerting, but as that's ending, you drift off into a more passive state, sleepwalking along as she uses your body as her own.";
		if HP of rubber tigress > 7 and location of player is State Fair and player is not neuter:
			...
			if player is herm:		[herm]
				...
				say "     After a bit of time just spent enjoying walking upright and casually feeling up her new body, she settles down to the main event, playing with those wonderful genitals she now possesses. Sliding a paw to [if cunts of player > 1]one of your [cunt size desc of player] cunts[else]your [cunt size desc of player] cunt[end if], she starts running her paw over the wet, sensitive folds. After a little teasing, she pushes a few fingers into the wet cunny and starts pumping away. She finds many a sensitive spot, most delightfully your clit[sfn], and gives particular attention to them. Much less frantic about her masturbation, but just as eager and overjoyed as ever, she plays with herself, and thereby with you, through several orgasms.";
				say "     All this dreamy pleasure has you moan softly, enjoying the feline's control of your body and the delight she takes in enjoying such pleasures you can take for granted at times. She goes at it for quite some time, though time is a difficult concept to hold onto during the erotic dreams of this somnambulistic state. As she's winding down, she delights in running her rubbery paws through the accumulated cum and juices sticking to herself and then licking them up. Eventually, you drift off to a deeper sleep with her still encapsulating you.";
			else:								[neuter]
...
to say artemissf_sex:
	...
	if player is male:
		say "     Being a [if player is female]partially [end if]male tiger, Artemis's cock immediately draws the horny feline's attention and soon she's on her knees licking and sucking at that throbbing rod. This sends shivers of delight through your both [if artemisstatefairrt is false]as your bonded companion gives a long sigh of relief at being finally accepted by the others[else]as your bonded companion releases a moan of pleasure[end if]. You are both treated to a wonderfully sensual blow job from the eager feline that only ends once she's gotten her tasty treat.";
		...
		if a random chance of 1 in 4 succeeds and artemisstatefairrt is true:
			...
			say "     They go at it like a lustful pair of cats in heat, the sounds of squeaking rubber and sticky sex fill the air as your body is used to pleasure the needy feline. Artemis puts the considerable talents she's learned while your companion to work, doing her best to satisfy the beautiful feline. Lost in the dream-like haze of lust and pleasure, you're made to thrust into the slutty feline, the pleasure building more and more. Eventually, it gets to be too much for both of you and you orgasm again, the two felines moaning and mrowling in ecstasy. This time the rubber tigress enveloping you doesn't let up until you're drained[if anallevel > 1], the rubber coating your bowels swelling into a bulge against your prostate and rubbing it firmly[else], the rubber covering you squeazing and rubbing at a myriad of the sensitive, erogenous spots she's discovered on your body[end if]. As her lover climbs off your spent shaft, Artemis looks down to show you both the creamy mess you've left inside her lover and the fact that she's drawn back her rubber coating from your glans, letting the tigress's juices into your system.";
	else if player is female:
		say "     Being a rubber tigress much like her newfound playmate, they know where to rub and grope to get each other worked up. You soon feel a pair of fingers sinking into your cunt while Artemis wraps her lips around one of those puffy nipples and suckles at it. This sends shivers of delight through your both [if artemisstatefairrt is false]as your bonded companion gives a long sigh of relief at being finally accepted by the others[else]as your bonded companion releases a moan of pleasure[end if]. You are both teased to a sticky climax that has hot juices running down your legs.";
		...
		if a random chance of 1 in 2 succeeds:
			...
			say "she gently coaxes the buxom kitty onto her knees and spreads her pussy - your pussy - as an invitation for her to dive in. Needing no more coaxing, she buries her muzzle between her lover's thighs and starts lapping at that juicy, [cunt size desc of player] cunt. Artemis mrowls in pleasure and rubs her paws over the tigress's head, urging her on.";
...
to say artemis_pm1:	[post-mod, fucking the new pussy]
	...
	if thirst of rubber tigress is 1:	[possesses a cock]
		...
		say "     Leaning overtop of the aroused kitty, you have her tilt her head towards your, kissing her muzzle. As you kiss, her cocktongue slides past your lips, drooling her lube-like pre into your mouth. She rumbles in pleasure as your tongue slides over it, licking over its textured surface. The feel of those soft barbs rubbing against your tongue makes you long to have them thrust into an even more intimate hole.";
...
to say artemis_set_genitals:
	if lust of rubber tigress is 1:				[resetting pre-engulf values]
		now cunts of rubber tigress is 1;
		now cunt length of rubber tigress is 12;
		now cunt width of rubber tigress is 9;
	else:
	...
	if thirst of rubber tigress is 1:
		...
		now cocks of rubber tigress is 0;
		now cock length of rubber tigress is 0;
		now cock width of rubber tigress is 0;
...
to say artemisengulf_mod_01:
	...
	if player is herm:		[herm setup]
		...
		if cocks of player > cocks of rubber tigress, now cocks of rubber tigress is cocks of player;
		if cock length of player > cock length of rubber tigress, now cock length of rubber tigress is cock length of player;
		if cock width of player > cock width of rubber tigress, now cock width of rubber tigress is cock width of player;
		if cunts of player > cunts of rubber tigress, now cunts of rubber tigress is cunts of player;
		if cunt length of player > cunt length of rubber tigress, now cunt length of rubber tigress is cunt length of player;
		if cunt width of player > cunt width of rubber tigress, now cunt width of rubber tigress is cunt width of player;
...
to say artemisengulf_mod_02:
	say "     Noticing your loyal tigress's longing looks, you decide it might be fun to snuggle up extra-close to your kitty again so you can have some fun together. Putting your gear down, you kneel down and welcome her into your arms. At first you only stroke and pet her, but soon you're pressing your [if bodyname of player is listed in infections of Felinelist]paws[else]hands[end if] against her giving hide firmly even as her own paws grow soft and cling to your [skinname of player] skin[if player is male]. You grind your stiff cock[smn] against her[else]. You rub your crotch against her, pressing your pussy against her[end if].";
	say "     With you pressing so eagerly against her, you soon feel her rubbery skin spreading over you as her melting rubber clings to your loins. Flowing latex spreads out from there over your hips and chest as you can feel the stuff [if player is herm]wrapping around your stiff manhood and sealing over your puss[yfn] before pushing further into you, coating and sealing your cunt[sfn] in a protective layer of herself[else if cocks of player > 1]wrapping around your stiff cocks and coating them in a snug, squeezing layer of herself[else if cocks of player is 1]wrapping around your stiff cock and coating it in a snug, squeezing layer of herself[else if player is female]encapsulating your juicy folds before pushing further into you, coating and sealing your cunt[sfn] in a protective layer of herself[end if][if libido of rubber tigress is 1 or thirst of rubber tigress is 1]. Her sextoy loins join with yours, melding to increase your mutual pleasure[else if ( cocks of player is 0 and thirst of rubber tigress is 1 ) or ( cunts of player is 0 or lust of rubber tigress > 0 )] and combining into a now herm tigress[end if].";
	...
	if a random chance of 1 in 3 succeeds:
		...
		say "     After having covered the rest of your [body size of player], [bodydesc of player] body, all that remains is your head. With her head still largely intact, but clearly softening in preparation of what's to come, she [if lust of rubber tigress is 2]runs her tongue teasingly across the labial folds of her lips[else if thirst of rubber tigress is 2]lets the tip of her dribbling cocktongue poke from her lips[else]gives you a tender smile[end if] and presses his flowing muzzle to your lips in a kiss. As you moan into your kiss, her [if thirst of rubber tigress is 2]penile tongue presses into your mouth, drooling flowing rubber goo down your throat, coating your insides. Her cocktongue flows across the rubber coating your tongue and joins with it, giving you a living latex dildo in your forming feline muzzle[else if lust of rubber tigress is 2]gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides. Her vaginal maw joins with the feline muzzle you're forming, allow you to share in the delights of her sexualized mouth[else]gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides[end if]. As her features start to settle into place, you start to drift off into the orange-tinted dreamscape that leaves your body hers to control. She gives a quick stretch and a playful grope that you share sensation in while she prepares for the next phase of her fun [if daytimer is day]day[else]night[end if] out.";

to say artemisengulf_mod_03:
	say "     Deciding to take a break, you put down your pack and move to take a seat. But as you're sitting down, you find your seat higher and more padded than you expected. Artemis, having jumped into your seat ahead of you lets her body soften and sag before starting to flow up over you. You [if player is male]chuckle[else]giggle[end if] as the sneaky kitty's managed to catch you. You try to struggle, but her rubbery coating continues to spread over you[if scalevalue of player > 3]. It takes some time and extra stretching on her part to be able to cover your [body size of player], [bodydesc of player] body, but she perseveres in her plan to hijack you for some fun[end if]. The feel of her flowing rubber [if player is herm]spreading over your dual genders is particularly pleasing, as always. The squeezing around your maleness and the feel of it flowing past your folds and into you[else if player is male]spreading over your throbbing cock[smn] is particularly pleasing, as always. The squeezing around your manhood and rubbing you all over[else if player is female]spreading across your wet folds is particularly pleasing, as always. And the feel of her then pushing into you to flow into your cunt[sfn][end if] is such a perverse delight[if lust of rubber tigress is 1 or thirst of rubber tigress is 1]. You feel a rush of sexual excitement as her sextoy genitals join with yours[end if][if ( cocks of player is 0 and thirst of rubber tigress is 1) or ( cunts of player is 0 and lust of rubber tigress is 1 )], combining your genders[end if][if anallevel > 1]. And more kinky pleasure comes when more flowing rubber presses at your tight pucker, spreading you open with ease so she can flow into your bowels and coat them as well[end if].";
...
to say artemis_mast_mod:
	say "     Having drifted into that pleasure-filled sleepwalking state you enjoy while engulfed by her, you share sensation with the rubbery tigress now covering and controlling your body. With you reformed into a [if cocks of rubber tigress > 0 and cunts of rubber tigress is 0]girlish tiger[else]sexy tigress[end if] made of rubber, she starts by reacquainting herself with her [if bodyname of player is listed in infections of taurlist]tauric[else]anthropomorphic[end if] form and delighting in how you share in her modifications in this union. ";
	if cocks of rubber tigress > 0 and cunts of rubber tigress > 0:	[herm bridge]
	...
	else if cocks of rubber tigress > 0:					[male bridge]
	...
	else if cunts of rubber tigress > 0:					[female bridge]
	...
	if thirst of rubber tigress is 3 and lust of rubber tigress is 2:
		...
		else if a random chance of 1 in 4 succeeds and cunts of rubber tigress > 0:
...
[		else if a random chance of 1 in 4 succeeds and cunts of rubber tigress > 0:
		...
		if a random chance of 2 in 5 succeeds:
			...
			say "     She pauses in this briefly to bend her rubber body with exceptional feline flexibility, bringing her muzzle in towards her loins. You release a sleepy moan as her pussy-mouth engulfs [if cocks of rubber tigress > 1]one of her throbbing cocks[else]her throbbing cock[end if]. Feeling both that meaty cock being sucked and the vaginal hole being penetrated is dizzyingly exciting. She bobs her muzzle up and down about a dozen times while thrusting up into her sextoy mouth before finally uncurling to return to fondling herself.";
	if cocks of rubber tigress > 0 and cunts of rubber tigress > 0:		[herm finale]
	...
	else if cocks of rubber tigress > 0:						[male finale]
	...
	else if cunts of rubber tigress > 0:						[female finale]
...
[	else if anallevel > 1 and ( cunts of rubber tigress is 0 and lust of rubber tigress is 0 ) and ( a random chance of anallevel in 12 succeeds or ( player is mpreg_ok and a random chance of 1 in 12 succeeds ) or ( player is submissive and a random chance of 1 in 12 succeeds ) ) and guy is not banned:	]
	if anallevel > 1 and ( cunts of rubber tigress is 0 and lust of rubber tigress is 0 ) and ( a random chance of anallevel in 12 succeeds or ( player is mpreg_ok and a random chance of 1 in 12 succeeds ) or ( player is submissive and a random chance of 1 in 12 succeeds ) ) and guy is not banned:
		say "[randombodypart]"; [yields male 'bodyselector']
		if bodyselector is "tiger":
			while bodyselector is "tiger":
				say "[randombodypart]";
		if a random chance of 3 in 5 succeeds or ( player is submissive and a random chance of 1 in 5 succeeds ):		[M/M bottom]
			...
			say "     Satisfied for now, the two part with the tiger sleepwalking you back to your gear and finds a spot to stretch out for a quick nap. You drift off fully into slumber as well, only to be awoken by the fully-reformed tigress nuzzling at your cheek. After some snuggling, you get up and head back on your way.";
	else if cunts of rubber tigress > 0 and ( cocks of rubber tigress is 0 or ( cocks of rubber tigress > 0 and a random chance of 1 in 2 succeeds ) ):		[M/F bottom]
		say "[randombodypart]"; [yields male 'bodyselector']
		say "male [bodyselector] enticed by the sultry [if cunts of rubber tigress > 0 and cocks of rubber tigress > 0]herm[else]female[end if]. Both eager for the main event, the foreplay is brief and ends with the tigress [one of]on all fours[or]bent over a bench[or]spread across the hood of a car[or]pinned against a wall[at random] with the male driving his cock into her hot, needy cunt (and thereby into you).";
		say "     She moans and mrowls at this treatment, squirming her hips into his thrusts and clenching her needy cunt around his pulsing meat, your body responding to her lustful desires. He pounds into the horny kitty, sending waves of pleasure through you both. Artemis, having learned a few tricks, wiggles her rear and rocks back into the thrusts to get even more pleasure from her current playmate. ";
		if thirst of rubber tigress is 2 and a random chance of 1 in 2 succeeds:
		...
		if slutname is "tigress":
			while slutname is "tigress":
				say "[randomdesc2]";
		say "female [slutname] enticed by the sultry [if cunts of rubber tigress > 0 and cocks of rubber tigress > 0]herm[else]male[end if]. After some lustful groping and fondling, they are both quite worked up and the rubber kitty has the [slutname] [one of]on the ground beneath her[or]pressed to a wall[or]bent over some rubble[or]spread across the hood of a car[at random].";
...
to say artemisnap_mod:
	if HP of rubber tigress < 11:
		...
		if HP of rubber tigress > 11 and location of player is State Fair and ( cocks of rubber tigress > 0 or cunts of rubber tigress > 0 ):
